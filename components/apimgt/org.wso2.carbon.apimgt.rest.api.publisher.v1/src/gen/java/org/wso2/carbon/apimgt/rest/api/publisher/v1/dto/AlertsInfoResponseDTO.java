...
public class AlertsInfoResponseDTO   {
    private List<AlertDTO> alerts = new ArrayList<AlertDTO>();    private List<String> emailList = new ArrayList<String>();    private List<AlertConfigDTO> failedConfigurations = new ArrayList<AlertConfigDTO>();
