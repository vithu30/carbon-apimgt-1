...
public interface AlertsApiService {
      public Response addAlertConfig(Map<String, String> body, String alertType, String configurationId, MessageContext messageContext) throws APIManagementException;
