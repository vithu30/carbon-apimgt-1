...
public class APIProductDTO   {
    private String id = null;    private String name = null;    private String context = null;    private String description = null;    private String provider = null;    private Boolean hasThumbnail = null;
    ...
    return null;
        ...
        }    private StateEnum state = null;    private Boolean enableSchemaValidation = null;    private Boolean enableStore = null;    private String testKey = null;    private Boolean responseCachingEnabled = null;    private Integer cacheTimeout = null;
    ...
    return null;
        ...
        }    private VisibilityEnum visibility = VisibilityEnum.PUBLIC;    private List<String> visibleRoles = new ArrayList<String>();    private List<String> visibleTenants = new ArrayList<String>();
    ...
    return null;
        ...
        }    private AccessControlEnum accessControl = AccessControlEnum.NONE;    private List<String> accessControlRoles = new ArrayList<String>();    private List<String> gatewayEnvironments = new ArrayList<String>();
    ...
    return null;
        ...
        }    private ApiTypeEnum apiType = null;    private List<String> transport = new ArrayList<String>();    private List<String> tags = new ArrayList<String>();    private List<String> policies = new ArrayList<String>();    private String apiThrottlingPolicy = null;    private String authorizationHeader = null;    private List<String> securityScheme = new ArrayList<String>();
    ...
    return null;
        ...
        }    private SubscriptionAvailabilityEnum subscriptionAvailability = SubscriptionAvailabilityEnum.ALL_TENANTS;    @Scope(name = "apim:api_publish", description="", value ="")
    private List<String> subscriptionAvailableTenants = new ArrayList<String>();    private Map<String, String> additionalProperties = new HashMap<String, String>();    private APIMonetizationInfoDTO monetization = null;    private APIProductBusinessInformationDTO businessInformation = null;    private APICorsConfigurationDTO corsConfiguration = null;    private java.util.Date createdTime = null;    private java.util.Date lastUpdatedTime = null;    private List<ProductAPIDTO> apis = new ArrayList<ProductAPIDTO>();    private List<APIScopeDTO> scopes = new ArrayList<APIScopeDTO>();    private List<String> categories = new ArrayList<String>();
