...
public class EndpointCertificatesApi  {
    ...
    @ApiOperation(value = "Download a Certificate", notes = "This operation can be used to download a certificate which matches the given alias. ", response = Void.class, authorizations = {
        @Authorization(value = "OAuth2Security", scopes = {
            @AuthorizationScope(scope = "", description = "")        })    }, tags={ "Endpoint Certificates" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 500,
                    ...
                    response = ErrorDTO.class) })
    public Response endpointCertificatesAliasContentGet(
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 500,
                    message = "Internal Server Error.",
                    response = ErrorDTO.class) })
    public Response endpointCertificatesAliasDelete(
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 500,
                    message = "Internal Server Error.",
                    response = ErrorDTO.class) })
    public Response endpointCertificatesAliasGet(
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 500,
                    message = "Internal Server Error.",
                    response = ErrorDTO.class) })
    public Response endpointCertificatesAliasPut(
...
,  @Size(max=30)
        @ApiParam(value = "Alias for the certificate") 
            @QueryParam("alias") String alias
, 
        @ApiParam(value = "Endpoint of which the certificate is uploaded") 
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 500,
                    message = "Internal Server Error.",
                    response = ErrorDTO.class) })
    public Response endpointCertificatesPost(

        @Multipart(value = "certificate") InputStream certificateInputStream, @Multipart(value = "certificate" ) Attachment certificateDetail, 
        @Multipart(value = "alias")  @Size(min=1,max=30) 
  String alias, 
        @Multipart(value = "endpoint")  
