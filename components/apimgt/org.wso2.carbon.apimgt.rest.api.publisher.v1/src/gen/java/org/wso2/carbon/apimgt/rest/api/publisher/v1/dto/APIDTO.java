...
public class APIDTO   {
    private String id = null;    private String name = null;    private String description = null;    private String context = null;    private String version = null;    private String provider = null;    @Scope(name = "apim:api_publish", description="", value ="")
    private String lifeCycleStatus = null;    private WSDLInfoDTO wsdlInfo = null;    private String wsdlUrl = null;    private String testKey = null;    private Boolean responseCachingEnabled = null;    private Integer cacheTimeout = null;    private String destinationStatsEnabled = null;    private Boolean hasThumbnail = null;    private Boolean isDefaultVersion = null;    private Boolean enableSchemaValidation = null;    @Scope(name = "apim:api_publish", description="", value ="")
    ...
    return null;
        ...
        }    private TypeEnum type = TypeEnum.HTTP;    private List<String> transport = new ArrayList<String>();    @Scope(name = "apim:api_publish", description="", value ="")
    private List<String> tags = new ArrayList<String>();    @Scope(name = "apim:api_publish", description="", value ="")
    private List<String> policies = new ArrayList<String>();    @Scope(name = "apim:api_publish", description="", value ="")
    private String apiThrottlingPolicy = null;    private String authorizationHeader = null;    private List<String> securityScheme = new ArrayList<String>();    private APIMaxTpsDTO maxTps = null;
    ...
    private VisibilityEnum visibility = VisibilityEnum.PUBLIC;    @Scope(name = "apim:api_publish", description="", value ="")
    private List<String> visibleRoles = new ArrayList<String>();    private List<String> visibleTenants = new ArrayList<String>();    private APIEndpointSecurityDTO endpointSecurity = null;    @Scope(name = "apim:api_publish", description="", value ="")
    private List<String> gatewayEnvironments = new ArrayList<String>();    @Scope(name = "apim:api_publish", description="", value ="")
    private List<DeploymentEnvironmentsDTO> deploymentEnvironments = new ArrayList<DeploymentEnvironmentsDTO>();    private List<String> labels = new ArrayList<String>();    private List<MediationPolicyDTO> mediationPolicies = new ArrayList<MediationPolicyDTO>();
    ...
    private SubscriptionAvailabilityEnum subscriptionAvailability = SubscriptionAvailabilityEnum.CURRENT_TENANT;    private List<String> subscriptionAvailableTenants = new ArrayList<String>();    @Scope(name = "apim:api_publish", description="", value ="")
    private Map<String, String> additionalProperties = new HashMap<String, String>();    private APIMonetizationInfoDTO monetization = null;
    ...
    return null;
        ...
        }    private AccessControlEnum accessControl = AccessControlEnum.NONE;    private List<String> accessControlRoles = new ArrayList<String>();    @Scope(name = "apim:api_publish", description="", value ="")
    private AllOfAPIBusinessInformationDTODTO businessInformation = null;    private APICorsConfigurationDTO corsConfiguration = null;    private String workflowStatus = null;    private java.util.Date createdTime = null;    @Scope(name = "apim:api_publish", description="", value ="")
    private java.util.Date lastUpdatedTime = null;    private Object endpointConfig = null;
    ...
    return null;
        ...
        }    private EndpointImplementationTypeEnum endpointImplementationType = EndpointImplementationTypeEnum.ENDPOINT;    private List<APIScopeDTO> scopes = new ArrayList<APIScopeDTO>();    private List<APIOperationsDTO> operations = new ArrayList<APIOperationsDTO>();    private APIThreatProtectionPoliciesDTO threatProtectionPolicies = null;    @Scope(name = "apim:api_publish", description="", value ="")
    private List<String> categories = new ArrayList<String>();    private Object keyManagers = null;
 ...
 @Size(max=50)
    ...
    **/
    ...
    /**
    **/
    public APIDTO businessInformation(AllOfAPIBusinessInformationDTODTO businessInformation) {
    ...
    public AllOfAPIBusinessInformationDTODTO getBusinessInformation() {
        return businessInformation;
    }

    public void setBusinessInformation(AllOfAPIBusinessInformationDTODTO businessInformation) {
        this.businessInformation = businessInformation;
    }
