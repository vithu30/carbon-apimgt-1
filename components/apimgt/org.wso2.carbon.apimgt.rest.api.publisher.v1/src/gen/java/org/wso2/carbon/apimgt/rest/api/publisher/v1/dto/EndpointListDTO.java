...
public class EndpointListDTO   {
    private Integer count = null;    private List<EndpointDTO> list = new ArrayList<EndpointDTO>();
    ...
    **/
    ...
    EndpointListDTO endpointList = (EndpointListDTO) o;
        return Objects.equals(count, endpointList.count) &&
        Objects.equals(list, endpointList.list);
    }
