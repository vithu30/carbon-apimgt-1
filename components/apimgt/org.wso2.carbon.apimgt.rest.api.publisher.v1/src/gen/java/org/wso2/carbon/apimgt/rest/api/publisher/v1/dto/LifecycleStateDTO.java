...
public class LifecycleStateDTO   {
    private String state = null;    private List<LifecycleStateCheckItemsDTO> checkItems = new ArrayList<LifecycleStateCheckItemsDTO>();    private List<LifecycleStateAvailableTransitionsDTO> availableTransitions = new ArrayList<LifecycleStateAvailableTransitionsDTO>();
