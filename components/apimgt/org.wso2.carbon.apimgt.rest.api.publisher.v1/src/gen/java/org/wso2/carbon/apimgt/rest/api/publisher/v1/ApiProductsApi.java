...
public class ApiProductsApi  {
    ...
    @ApiOperation(value = "Delete an API Product", notes = "This operation can be used to delete an existing API Product proving the Id of the API Product. ", response = Void.class, authorizations = {
        @Authorization(value = "OAuth2Security", scopes = {
            @AuthorizationScope(scope = "", description = "")        })    }, tags={ "API Products" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 412,
                    ...
                    response = ErrorDTO.class) })
    public Response apiProductsApiProductIdDelete(

        @ApiParam(value = "**API Product ID** consisting of the **UUID** of the API Product. Using the **UUID** in the API call is recommended. ",required=true)
...
, 
    ...
    @ApiOperation(value = "Get the Content of an API Product Document", notes = "This operation can be used to retrive the content of an API's document.  The document can be of 3 types. In each cases responses are different.  1. **Inline type**:    The content of the document will be retrieved in `text/plain` content type     _Sample cURL_ : `curl -k -H \"Authorization:Bearer 579f0af4-37be-35c7-81a4-f1f1e9ee7c51\" -F inlineContent=@\"docs.txt\" -X POST \"https://localhost:9443/api/am/publisher/v1/apis/995a4972-3178-4b17-a374-756e0e19127c/documents/43c2bcce-60e7-405f-bc36-e39c0c5e189e/content` 2. **FILE type**:    The file will be downloaded with the related content type (eg. `application/pdf`) 3. **URL type**:     The client will recieve the URL of the document as the Location header with the response with - `303 See Other` ", response = Void.class, authorizations = {
        @Authorization(value = "OAuth2Security", scopes = {
            @AuthorizationScope(scope = "", description = "")        })    }, tags={ "API Product Documents" })
    @ApiResponses(value = { 
        @ApiResponse(code = 200,
...
, 
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 406,
                    message = "Not Acceptable. The requested media type is not supported.",
                    response = ErrorDTO.class) })
    public Response apiProductsApiProductIdDocumentsDocumentIdGet(
...
, 
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 412,
                    message = "Precondition Failed. The request has not been performed because one of the preconditions is not met.",
                    response = ErrorDTO.class) })
    public Response apiProductsApiProductIdDocumentsDocumentIdPut(
...
, 
        ...
        return delegate.apiProductsApiProductIdDocumentsDocumentIdPut(body, apiProductId, documentId, ifMatch, securityContext);
    }
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 406,
                    message = "Not Acceptable. The requested media type is not supported.",
                    response = ErrorDTO.class) })
    public Response apiProductsApiProductIdDocumentsGet(
...
, 
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 415,
                    ...
                    response = ErrorDTO.class) })
    public Response apiProductsApiProductIdDocumentsPost(
...
, 
        ...
        return delegate.apiProductsApiProductIdDocumentsPost(body, apiProductId, securityContext);
    }
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200,
                    message = "OK. Requested API Product is returned ",
        ...
        @ApiResponse(code = 406,
                    message = "Not Acceptable. The requested media type is not supported.",
                    response = ErrorDTO.class) })
    public Response apiProductsApiProductIdGet(
...
, 
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200,
                    ...
                    response = APIProductOutdatedStatusDTO.class),
        @ApiResponse(code = 304,
                    message = "Not Modified. Empty body because the client has already the latest version of the requested resource (Will be supported in future). ",
                    response = Void.class),
        @ApiResponse(code = 404,
        ...
        @ApiResponse(code = 406,
                    message = "Not Acceptable. The requested media type is not supported.",
                    response = ErrorDTO.class) })
    public Response apiProductsApiProductIdIsOutdatedGet(
...
, 
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200,
                    message = "OK. Successful response with updated API product object ",
                    response = APIProductDTO.class),
        @ApiResponse(code = 400,
                    message = "Bad Request. Invalid request or validation error.",
                    response = ErrorDTO.class),
        ...
        @ApiResponse(code = 412,
                    message = "Precondition Failed. The request has not been performed because one of the preconditions is not met.",
                    response = ErrorDTO.class) })
    public Response apiProductsApiProductIdPut(

        @ApiParam(value = "API object that needs to be added",required=true) APIProductDTO body
, 
...
, 
        ...
        return delegate.apiProductsApiProductIdPut(body, apiProductId, ifMatch, securityContext);
    }
...
, 
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 406,
                    message = "Not Acceptable. The requested media type is not supported.",
                    response = ErrorDTO.class) })
    public Response apiProductsApiProductIdThumbnailGet(
...
, 
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 412,
                    message = "Precondition Failed. The request has not been performed because one of the preconditions is not met.",
                    response = ErrorDTO.class) })
    public Response apiProductsApiProductIdThumbnailPut(
...
, 
        ...
        return delegate.apiProductsApiProductIdThumbnailPut(fileInputStream, fileDetail, apiProductId, ifMatch, securityContext);
    }
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200,
                    message = "OK. List of qualifying API Products is returned. ",
...
, 
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 415,
                    message = "Unsupported Media Type. The entity of the request was not in a supported format.",
                    response = ErrorDTO.class) })
    public Response apiProductsPost(
