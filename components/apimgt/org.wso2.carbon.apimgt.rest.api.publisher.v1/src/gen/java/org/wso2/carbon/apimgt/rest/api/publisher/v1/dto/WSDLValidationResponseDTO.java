...
public class WSDLValidationResponseDTO   {
    private Boolean isValid = null;    private List<ErrorListItemDTO> errors = new ArrayList<ErrorListItemDTO>();    private WSDLValidationResponseWsdlInfoDTO wsdlInfo = null;
