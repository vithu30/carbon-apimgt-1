...
public class ScopesApi  {
    ...
    @ApiOperation(value = "Add a New Shared Scope", notes = "This operation can be used to add a new Shared Scope. ", response = ScopeDTO.class, authorizations = {
        @Authorization(value = "OAuth2Security", scopes = {
            @AuthorizationScope(scope = "", description = "")        })    }, tags={ "Scopes" })
    @ApiResponses(value = { 
        @ApiResponse(code = 201,
                    message = "Created. Successful response with the newly created Scope object as an entity in the body. ",
        ...
        @ApiResponse(code = 415,
                    ...
                    response = ErrorDTO.class) })
    public Response addSharedScope(
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 404,
                    ...
                    response = ErrorDTO.class) })
    public Response deleteSharedScope(

        @ApiParam(value = "Scope Id consisting the UUID of the shared scope ",required=true)
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200,
                    message = "OK. Requested Shared Scope is returned. ",
                    response = ScopeDTO.class),
        @ApiResponse(code = 404,
                    message = "Not Found. The specified resource does not exist.",
                    response = ErrorDTO.class) })
    public Response getSharedScope(
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200,
                    message = "OK. Usages of the shared scope is returned. ",
                    response = SharedScopeUsageDTO.class),
        @ApiResponse(code = 404,
                    message = "Not Found. The specified resource does not exist.",
                    response = ErrorDTO.class) })
    public Response getSharedScopeUsages(
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200,
                    message = "OK. Shared Scope list is returned. ",
                    response = ScopeListDTO.class),
        @ApiResponse(code = 500,
                    message = "Internal Server Error.",
                    response = ErrorDTO.class) })
    public Response getSharedScopes(
...
, 
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200,
                    message = "OK. Successful response with updated Scope object ",
                    response = ScopeDTO.class),
        @ApiResponse(code = 400,
                    message = "Bad Request. Invalid request or validation error.",
                    response = ErrorDTO.class),
        @ApiResponse(code = 404,
                    message = "Not Found. The specified resource does not exist.",
                    response = ErrorDTO.class) })
    public Response updateSharedScope(

        @ApiParam(value = "Scope object that needs to be updated",required=true) ScopeDTO body
, 

        @ApiParam(value = "Scope Id consisting the UUID of the shared scope ",required=true)
            @PathParam("scopeId") String scopeId
) throws APIManagementException{
        return delegate.updateSharedScope(body, scopeId, securityContext);
    }
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200,
                    message = "OK. Requested scope name exists.",
                    response = Void.class),
        @ApiResponse(code = 404,
                    message = "Not Found. The specified resource does not exist.",
                    response = ErrorDTO.class) })
    public Response validateScope(

        @ApiParam(value = "Scope name ",required=true)
            @PathParam("scopeId") String scopeId
) throws APIManagementException{
